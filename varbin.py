...
# -*- coding:UTF-8 -*-
import sys
import pysam ##mļef main():

        infilename = sys.argv[1]
        outfilename = sys.argv[2]
        statfilename = sys.argv[3]

        chrominfo = fileToDictionary("hg19.chrom.sizes.txt", 0)
        bins = fileToArray("hg19.bin.boundaries.50k.bowtie.k50.sorted.txt", 0)
        INFILE = pysam.AlignmentFile(infilename, "rb") ##
